...
const testSteps = [
  ...
  },
  {
    ...
    description: 'Убедитесь, что на телевизоре выбран правильный источник сигнала',
  ...
  },
  {
    ...
    instruction: 'Зайдите в Настройки → Система → Память → Очистить кэш. Подтвердите действие и дождитесь з��вершения процесса.',
    estimated_time: 120,
...
export const seedDatabase = async () => {
  try {
    ...
    console.log(`   - ${testDevices.length} устрой��тв`);
